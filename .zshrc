...
for _fnfile in $ZDOTDIR/functions/*(.N); do
...
if zstyle -t ':zsh:module:completion:*' case-sensitive; then
...
zstyle -a ':zsh:module:completion:*:hosts' etc-host-ignores '_etc_host_ignores'
...
[[ ${ZSH_DEFER_COMPINIT:-false} = true ]] || run-compinit
#endregion
